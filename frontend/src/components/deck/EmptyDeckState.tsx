...
export const EmptyDeckState: React.FC<EmptyDeckStateProps> = ({ onCreateDeck }) => {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h3 className="text-xl font-semibold text-gray-900 mb-2">Create your first study deck</h3>
      <p className="text-gray-600 text-center max-w-md mb-6">
        Organize your learning materials into decks. Each deck can contain flashcards generated from
        AI mnemonics.
      </p>
